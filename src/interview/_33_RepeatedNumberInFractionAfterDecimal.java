...
import algorithm.RepeatingDecimalBracket;

class _33_RepeatedNumberInFractionAfterDecimal {
	/**
	...
	public static void main(String args[]) {
		...
		if (RepeatingDecimalBracket.fractionToDecimal(1, 2).equals("0.5") && RepeatingDecimalBracket.fractionToDecimal(6, 11).equals("0.(54)")
				&& RepeatingDecimalBracket.fractionToDecimal(1, 3).equals("0.(3)")) {
			System.out.println(RepeatingDecimalBracket.fractionToDecimal(23, 22));
